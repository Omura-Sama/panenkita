...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 29, 2020 at 03:39 PM
...
INSERT INTO `pesan` (`id_pesan`, `tanggal_pesan`, `isi_pesan`, `unicode`, `id_user`, `pengirim`) VALUES
(1, '2020-10-30 00:00:00', 'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eligendi incidunt maxime accusamus, sint laudantium in quo facere pariatur modi maiores mollitia possimus assumenda nam soluta saepe debitis laboriosam excepturi repellendus?', 'PESAN-3', '3', 'admin'),
(2, '2020-10-29 00:00:00', 'Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eligendi incidunt maxime accusamus, sint laudantium in quo facere pariatur modi maiores mollitia possimus assumenda nam soluta saepe debitis laboriosam excepturi repellendus?', 'PESAN-3', '1', 'tengkulak'),
(3, '2020-10-29 03:51:03', 'TES kirim pesan', 'PESAN-3', '1', 'tengkulak');
...
INSERT INTO `produk` (`id_produk`, `id_petani`, `nama_produk`, `nama_petani`, `nama_kategori`, `foto_produk`, `tanggal_panen`, `stok_produk`, `deskripsi_produk`, `harga_produk`) VALUES
(3, 0, 'Pisang', 'Abdullah', 'Kategori Tes 1', 0x706973616e672e6a706567, '0000-00-00', 10, 'Pisang Kebon', 12000);
...
CREATE TABLE `tengkulak` (
  ...
  `tanggal_lahir_tengkulak` date NOT NULL,
  `alamat_tengkulak` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;
...
INSERT INTO `tengkulak` (`id_tengkulak`, `id_user`, `nama_depan_tengkulak`, `nama_belakang_tengkulak`, `email_tengkulak`, `password_tengkulak`, `kontak_tengkulak`, `foto_tengkulak`, `tanggal_lahir_tengkulak`, `alamat_tengkulak`) VALUES
(1, 3, 'Abdul', 'Rohim', 'abdulrohim@gmail.com', '12345', '082123456789', NULL, '0000-00-00', '');
...
(2, 'user_petani', '12345', 1, 'userpetani@gmail.com', 4),
(3, 'user_tengkulak', '12345', 1, 'usertengkulak@gmail.com', 3);
...
--
ALTER TABLE `pesan`
  MODIFY `id_pesan` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `produk`
  MODIFY `id_produk` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tengkulak`
  MODIFY `id_tengkulak` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
