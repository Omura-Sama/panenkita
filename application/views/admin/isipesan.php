            ...
            <div class="card" style="border-radius: 10px;">
                ...
                <div
                    ...
                    <div class="row" style="margin-bottom:10px;">
                        ...
                        <div class="col-4">
                            <p style="font-size: 16px; color:#000000; text-align:right;"><?=$tanggal?> <span
                                    class="fas fa-calendar-alt"></span></p>
                        </div>
                    </div>
                                ...
                                <tr>
                                    <td>
                                        <div class="row">
                                            ...
                                            <div class="col-2">
                                                <img class="imgPesan" src="<?= base_url('assets/img/default.jpg'); ?>"
                                                    alt="" width="60px" style="position:initial; border-radius: 30px;">
                                            </div>
                                        </div>
                                    </td>
                                </tr>
