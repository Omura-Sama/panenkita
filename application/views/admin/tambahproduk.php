            ...
            <div class="card" style="border-radius: 10px;">
                ...
                <div
                    ...
                    <form action="<?php echo base_url() ?>index.php/admin/insertProduk" method="POST">
                        <div class="row">
                            <div class="col-6">
                                <p style="font-size: 26px; font-weight: bold; color:#264E36;margin-bottom:20px">TAMBAH
                                    PRODUK</p>
                            </div>
                            ...
                            <div class="col-6">
                                <div class="custom-file" style="margin: 30px 0px;">
                                    <input type="file" class="custom-file-input" id="foto" name="foto"
                                        style="display: none;">
                                    <label for="foto">
                                        <img src="<?= base_url('assets/img/default.jpg'); ?>" alt="Upload Foto"
                                            width="50px">
                            ...
                            <div class="col">
                                <div class="input-group">
                                    <div class="wrap-input100 validate-input m-b-10"
                                        data-validate="Masukan Nama Produk">
                            ...
                            <div class="col-6">
                                <div class="input-group">
                                    <div class="wrap-input100 validate-input m-t-10 m-b-10">
                                        <select class="custom-select" name="nama_petani" id="nama_petani"
                                            style="border: 0;box-shadow:none;">
                                            <option value="">- Pilih Nama Petani -</option>
                                            <?php foreach ($listpetani as $key) : ?>
                                            <option value="<?= $key->nama_petani; ?>"> <?= $key->nama_petani; ?>
                                            </option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                                ...
                                <div class="input-group">
                                    <div class="wrap-input100 validate-input m-t-10 m-b-10">
                                        ...
                                        <select class="custom-select" name="kategori" id="kategori"
                                            ...
                                            <option value="<?= $key->name_kategori; ?>"> <?= $key->name_kategori;  ?>
                                            </option>
                                            <?php endforeach ?>
                                        </select>
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                <div class="wrap-input100 validate-input m-t-10 m-b-10"
                                    data-validate="Masukan Stok / Kuintal">
                                    <div class="input-group date" id="tanggal" data-target-input="nearest">
                                        <input type="text" name="tanggal" id="tanggal"
                                            class="form-control datetimepicker-input" data-target="#tanggal"
                                            style="border: 0;box-shadow:none;" placeholder="Pilih Tanggal Panen" />
                                        <label for="tanggal">
                                            <div class="input-group-append" data-target="#tanggal"
                                                data-toggle="datetimepicker">
                                                <div class="input-group-text"
                                                    style="border:0;background-color:#ffffff;"><i
                            ...
                            <div class="col">
                                <div class="input-group">
                                    <div class="wrap-input100 validate-input m-t-15 m-b-20"
                                        data-validate="Masukan Deskripsi Produk">
                                        <textarea class="input100" name="deskripsi" id="deskripsi"
                                            style="height:70px;padding:10px;"></textarea>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="input-group">
                                    <div class="wrap-input100 validate-input m-b-10"
                                        data-validate="Masukan Harga / Rupiah">
