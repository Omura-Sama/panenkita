                ...
                <div class="row">
                    ...
                    <?php foreach ($userData as $key ): ?>
                        ...
                        <p style="font-size: 20px; font-weight: bold; color:#000000;">SELAMAT DATANG  
                            <?php echo $key->nama_depan_petani." ".$key->nama_belakang_petani; ?> 
                        </p>
                        <div class="card-body" style="height: 410px;">
                            ...
                            <div class="row pb-3" style="color:#000000;">
                                <div class="col-6">
                                    <b>Nama Depan :</b><br>
                                    <?php echo $key->nama_depan_petani; ?>
                                </div>
                                <div class="col-6">
                                    <b>Nama Belakang :</b><br>
                                    <?php echo $key->nama_belakang_petani; ?>
                                </div>
                            </div>
                            <div class="row pb-3" style="color:#000000;">
                                <div class="col">
                            ...
                            <a href="<?= site_url('petani/edit/'.$key->id_user) ?>" class="btn btn-default">UBAH</a>
                        </div>
                        <?php endforeach ?>
                    </div>
                </div>
